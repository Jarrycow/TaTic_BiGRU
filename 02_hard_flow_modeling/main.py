...
def get_args():
    ...
    parser.add_argument('-model_name', metavar='INPUT', type=str, default='./in_channel_{}-in_kernel_{}-layers_{}-seq_len_{:0>2d}-ker_size_{:0>2d}-fold_{}')  # 输出模型名称
...
if __name__ == '__main__':
    ...
    max_acc = 0  # 掌握最大验证精度
    for epoch in range(num_epochs):  # 对模型进行指定数量的迭代训练
